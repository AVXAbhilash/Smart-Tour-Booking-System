...
function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.email === 'Admin1' && formData.password === '1234') {
      // If credentials match the admin backdoor, send to admin portal
      navigate('/admin/dashboard');
    } else {
      // Otherwise, send to the normal user home page
      navigate('/home');
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              {/* Changed type from "email" to "text" so "Admin1" doesn't trigger a browser error */}
              <input
                type="text"
                name="email"
                required
